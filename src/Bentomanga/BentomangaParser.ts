...
export const parseBentomangaMangaDetails = ($: CheerioStatic, mangaId: string): Manga => {
...
export const parseBentomangaChapterDetails = (data: string, mangaId: string, chapterId: string, id: string): ChapterDetails => {
    const pages: string[] = []
