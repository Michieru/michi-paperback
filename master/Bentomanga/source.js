...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Bentomanga = exports.BentomangaInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const BentomangaParser_1 = require("./BentomangaParser");
const BENTOMANGA_DOMAIN = "https://www.bentomanga.com";
const method = 'GET';
const headers = {
    'Host': 'www.bentomanga.com',
};
exports.BentomangaInfo = {
    version: '1.2.1',
    name: 'Bentomanga',
    icon: 'logo.png',
    author: 'Michieru',
...
class Bentomanga extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        this.requestManager = createRequestManager({
            ...
            interceptor: {
                interceptRequest: (request) => __awaiter(this, void 0, void 0, function* () {
                    request.headers = {
                        'Referer': 'https://www.bentomanga.com/'
                    };
                    return request;
                }),
    ...
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield BentomangaParser_1.parseBentomangaMangaDetails($, mangaId);
        });
    }
    //////////////////////////
    /////    CHAPTERS    /////
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (page_max == 0) {
                for (let chapter of $('#chapters div[data-row=chapter]').toArray()) {
                    const id = `https://www.bentomanga.com${(_a = $('a', chapter).eq(0).attr('href')) !== null && _a !== void 0 ? _a : ''}`;
                    const name = $('a', chapter).eq(0).children().text().replace(/^ -/, '').trim() != '' ? BentomangaParser_1.decodeHTMLEntity($('a', chapter).eq(0).children().text().replace(/^ -/, '').trim()) : undefined;
                    ...
                    const time = BentomangaParser_1.parseDate($('a', chapter).eq(0).parent().next().next().clone().children().remove().end().text().trim().replace(/-/g, '.'));
                ...
                for (var page = 1; page <= page_max; page++) {
                    ...
                    let $ = this.cheerio.load(response.data);
                    for (let chapter of $('#chapters div[data-row=chapter]').toArray()) {
                        const id = `https://www.bentomanga.com${(_f = $('a', chapter).eq(0).attr('href')) !== null && _f !== void 0 ? _f : ''}`;
                        const name = $('.manga_title', chapter).text().trim() != '' ? BentomangaParser_1.decodeHTMLEntity($('.manga_title', chapter).text().trim()) : undefined;
    ...
    getChapterDetails(mangaId, chapterId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            this.CloudFlareError(response.status);
            return yield BentomangaParser_1.parseBentomangaChapterDetails(response.data, mangaId, chapterId, id);
        });
    }
    ////////////////////////////////
    /////    SEARCH REQUEST    /////
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query.includedTags && ((_d = query.includedTags) === null || _d === void 0 ? void 0 : _d.length) != 0) {
                ...
                this.CloudFlareError(response.status);
                const $ = this.cheerio.load(response.data);
                manga = BentomangaParser_1.parseSearch($);
                metadata = !BentomangaParser_1.isLastPage($) ? { page: page + 1 } : undefined;
            }
            else {
                const request = createRequestObject({
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CloudFlareError(response.status);
            const $ = this.cheerio.load(response.data);
            BentomangaParser_1.parseHomeSections($, [section1, section2, section3, section4], sectionCallback);
        });
    }
    /////////////////////////////////
    /////    VIEW MORE ITEMS    /////
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CloudFlareError(response.status);
            const $ = this.cheerio.load(response.data);
            const manga = BentomangaParser_1.parseLatestUpdatedManga($);
            metadata = !BentomangaParser_1.isLastPage($) ? { page: page + 1 } : undefined;
            return createPagedResults({
                results: manga,
                metadata
    ...
    getSearchTags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CloudFlareError(response.status);
            const $ = this.cheerio.load(response.data);
            return BentomangaParser_1.parseTags($);
        });
    }
    //////////////////////////////////////
    ...
    filterUpdatedManga(mangaUpdatesFoundCallback, time, ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (updatedManga.loadMore) {
                ...
                this.CloudFlareError(response.status);
                const $ = this.cheerio.load(response.data);
                updatedManga = BentomangaParser_1.parseUpdatedManga($, time, ids);
...
exports.Bentomanga = Bentomanga;

},{"./BentomangaParser":49,"paperback-extensions-common":5}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseDate = exports.decodeHTMLEntity = exports.parseUpdatedManga = exports.isLastPage = exports.parseTags = exports.parseHomeSections = exports.parseLatestUpdatedManga = exports.parseSearch = exports.parseBentomangaChapterDetails = exports.parseBentomangaMangaDetails = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const BENTOMANGA_DOMAIN = "https://www.bentomanga.com";
///////////////////////////////
/////    MANGA DETAILS    /////
///////////////////////////////
const parseBentomangaMangaDetails = ($, mangaId) => {
    var _a, _b, _c, _d, _e;
...
exports.parseBentomangaMangaDetails = parseBentomangaMangaDetails;
/////////////////////////////////
/////    CHAPTER DETAILS    /////
/////////////////////////////////
const parseBentomangaChapterDetails = (data, mangaId, chapterId, id) => {
    const pages = [];
    for (let item of JSON.parse(data).page_array) {
        let page = encodeURI(`${BENTOMANGA_DOMAIN}/images/mangas/chapters/${id}/${item}`);
...
exports.parseBentomangaChapterDetails = parseBentomangaChapterDetails;
////////////////////////
/////    SEARCH    /////
////////////////////////
const parseSearch = ($) => {
...
const parseTags = ($) => {
    ...
    for (let item of $('.category_item').toArray()) {
        ...
        let label = capitalizeFirstLetter(decodeHTMLEntity((_b = $(item).attr('id')) !== null && _b !== void 0 ? _b : ''));
        arrayTags.push({ id: id, label: label });
    }
...
const parseUpdatedManga = ($, time, ids) => {
    ...
    let loadMore = true;
    for (const item of $('.table-responsive tbody .manga').toArray()) {
        let id = (_b = ((_a = $(item).next().children('td').eq(1).children('.text-truncate').attr('href')) !== null && _a !== void 0 ? _a : '').split('/').pop()) !== null && _b !== void 0 ? _b : '';
        let mangaTime = new Date(((_c = $(item).next().children('td').last().find('time').attr('datetime')) !== null && _c !== void 0 ? _c : '').replace(/ CET/g, ''));
        if (mangaTime > time)
            if (ids.includes(id))
                manga.push(id);
            else
