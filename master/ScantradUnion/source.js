    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return createPagedResults({
                results: ScantradUnionParser_1.parseSearch($),
...
},{"./ScantradUnionParser":52,"buffer":3,"paperback-extensions-common":8}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const parseScantradUnionMangaDetails = ($, mangaId) => {
    ...
    const author = (_a = $('a[href*=auteur]', panel).eq(0).text().trim()) !== null && _a !== void 0 ? _a : undefined;
    const artist = (_b = $('a[href*=auteur]', panel).eq(1).text().trim()) !== null && _b !== void 0 ? _b : undefined;
    ...
    for (const genre of $('a[href*=tag]', panel).toArray()) {
        const id = (_c = $(genre).attr("href")) === null || _c === void 0 ? void 0 : _c.split('/')[4]; // id of tag is incorrect because need 'int' id but there is 'string' id 
...
const parseSearch = ($) => {
    ...
    for (const item of $('article').toArray()) {
        manga.push(createMangaTile({
            id: (_b = (_a = $('.thumb-link', item).attr('href')) === null || _a === void 0 ? void 0 : _a.split('/')[4]) !== null && _b !== void 0 ? _b : '',
...
const parseLatestManga = ($) => {
    ...
    for (const item of $('.majflow #dernierschapitres.dernieresmaj .colonne').toArray()) {
        const id = (_a = $('.carteinfos .text-truncate', item).attr('href')) === null || _a === void 0 ? void 0 : _a.split('/')[4];
